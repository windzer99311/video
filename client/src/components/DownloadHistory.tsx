    ...
    <div className="bg-card rounded-lg p-6 shadow-lg">
      ...
      <div className="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-700 rounded-lg p-3 mb-4 text-sm text-yellow-800 dark:text-yellow-200">
        <div className="flex items-center">
          ...
          <div>
            <p className="font-medium">Downloads are temporary</p>
            <p className="mt-1">Please download your files immediately as they will be automatically removed when the server restarts or after periods of inactivity.</p>
          </div>
        </div>
      </div>
